...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { page_id: @checklist.page_id, title: @checklist.title } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { page_id: @checklist.page_id, title: @checklist.title } }
